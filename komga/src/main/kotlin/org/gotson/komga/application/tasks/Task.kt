...
sealed class Task(val priority: Int = DEFAULT_PRIORITY, val groupId: String? = null) {
  ...
  class ScanSeries(val seriesId: String, priority: Int = DEFAULT_PRIORITY, val scanDeep: Boolean) : Task(priority) {
    override val uniqueId = "SCAN_SERIES_$seriesId"
    override fun toString(): String = "ScanSeries(seriesId='$seriesId' priority='$priority', scanDeep=$scanDeep)"
  }
  ...
  class FixThumbnailsBooksWithoutMetadata(priority: Int = DEFAULT_PRIORITY) : Task(priority, "FixThumbnailsBooksWithoutMetadata") {
    override val uniqueId = "FIX_THUMBNAILS_BOOKS_WITHOUT_METADATA_${LocalDateTime.now()}"
    override fun toString(): String = "FixThumbnailsBooksWithoutMetadata(priority='$priority')"
  }

  class FixThumbnailsSeriesWithoutMetadata(priority: Int = DEFAULT_PRIORITY) : Task(priority, "FixThumbnailsSeriesWithoutMetadata") {
    override val uniqueId = "FIX_THUMBNAILS_SERIES_WITHOUT_METADATA_${LocalDateTime.now()}"
    override fun toString(): String = "FixThumbnailsSeriesWithoutMetadata(priority='$priority')"
  }

  class FixThumbnailsSeriesCollectionsWithoutMetadata(priority: Int = DEFAULT_PRIORITY) : Task(priority, "FixThumbnailsSeriesCollectionsWithoutMetadata") {
    override val uniqueId = "FIX_THUMBNAILS_SERIES_COLLECTIONS_WITHOUT_METADATA_${LocalDateTime.now()}"
    override fun toString(): String = "FixThumbnailsSeriesCollectionsWithoutMetadata(priority='$priority')"
  }

  class FixThumbnailsReadListsWithoutMetadata(priority: Int = DEFAULT_PRIORITY) : Task(priority, "FixThumbnailsReadListsWithoutMetadata") {
    override val uniqueId = "FIX_THUMBNAILS_READ_LISTS_WITHOUT_METADATA_${LocalDateTime.now()}"
    override fun toString(): String = "FixThumbnailsReadListsWithoutMetadata(priority='$priority')"
  }
