...
class OpdsController(
  ...
  fun getLatestSeriesForLibrary(
    ...
    libraryRepository.findByIdOrNull(id)?.let { library ->
      ...
      val seriesPage = seriesDtoRepository.findAllRecentlyUpdated(
        seriesSearch,
        principal.user.id,
        principal.user.restrictions,
        pageable,
  ...
  private fun Library.toLatestOpdsEntry(idPrefix: String, nameSuffix: String, routePrefix: String): OpdsEntryNavigation =
    OpdsEntryNavigation(
