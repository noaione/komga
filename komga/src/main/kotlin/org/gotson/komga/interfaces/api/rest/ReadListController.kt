...
class ReadListController(
  ...
  fun addUserUploadedReadListThumbnail(
    ...
    readListRepository.findByIdOrNull(id, principal.user.getAuthorizedLibraryIds(null), principal.user.restrictions)?.let { readList ->
      ...
      val readListThumbUrl = thumbnailLifecycle.saveThumbnailToDiskIfDiskMode(file.bytes, readList.id, ThumbnailLifecycle.Type.READ_LIST)
      var thumbReadList = ThumbnailReadList(
      ...
      if (readListThumbUrl != null) {
        thumbReadList = thumbReadList.copy(
